...
const MonthlyMetrics = ({ prevMonth, prevYear }: { prevMonth: MonthlyMetricsData, prevYear: MonthlyMetricsData }) => {
  const [compareWith, setCompareWith] = useState('previous month');
  const [metrics, setMetrics] = useState<Metric[]>([]);
  const [month, setMonth] = useState('');

  useEffect(() => {
    const data = compareWith === 'previous month' ? prevMonth : prevYear;
        ...
        const newMetrics: Metric[] = [
            {
                ...
                description: 'Percentage of customers who would recommend British Airways to others',
            },
            {
                label: 'VFM Score',
                ...
                changeLabel: `${compareWith}`,
                description: 'Value for Money score based on customer feedback and ratings',
            },
            {
                ...
                changeLabel: `${compareWith}`,
                description: 'Overall customer satisfaction rating across all review categories',
            },
            {
                ...
                changeLabel: `${compareWith}`,
                description: 'Total number of customer reviews submitted during this period',
            },
        ];
  ...
  }, [compareWith, prevMonth, prevYear]);
