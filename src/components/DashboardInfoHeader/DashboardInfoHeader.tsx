...
const DashboardInfoHeader =  () => {
  ...
  return (
  <div className="card bg-white dark:bg-gray-800 text-gray-700 dark:text-white p-6 rounded-lg mb-6">
    ...
    <div className="mb-2">
      <label className="mr-2 text-sm text-gray-700 dark:text-white">Compare with:</label>
      <select
